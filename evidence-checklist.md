...
## Representative Artifacts for Bank Diligence

A practical checklist of representative artifacts an AI vendor may prepare before entering bank diligence. Organized by area, with the reason a bank may ask for each item and the internal team most likely to own it.
...
| Artifact | Why a bank may ask for it | Likely internal owner |
|---|---|---|
| SOC 2 Type II report (under NDA) | Third-party attestation that security controls were in place and operating over a period of time, not just at a point in time | Security / Compliance |
...
| Subprocessor list with roles and processing locations | Helps the bank assess fourth-party risk and understand where customer data goes through the vendor supply chain | Legal / Privacy |
...
| MFA policy | Confirms that multi-factor authentication is enforced for internal access to production systems and customer data | Security / IT |
...
| Training prohibition attestation (written) | Written confirmation that customer data is not used for model training or improvement | Legal / Security |
...
| Model change management documentation | Shows model or prompt changes are evaluated, approved, and monitored before affecting customer workflows | Product / Engineering / Security |
...
| Artifact | Why a bank may ask for it | Likely internal owner |
|---|---|---|
| Full subprocessor list with roles and locations | Helps the bank assess fourth-party risk; regulators expect banks to understand where their data goes through the vendor supply chain | Legal / Procurement |
...
| Critical subprocessor assurance evidence | Evidence that key suppliers, particularly hosting and model providers, are subject to independent validation or vendor risk review | Security / Compliance |
...
*This checklist is a fictional sample created for educational and portfolio purposes. It does not represent a complete compliance program or a universal requirement. Actual artifact requests vary by customer, jurisdiction, and regulatory context.*
